/* src/config/mitra-config.h.  Generated from mitra-config.h.in by configure.  */
/* src/config/mitra-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Mitra_CONFIG_H

#define Mitra_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.mitra.co"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Mitra Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Mitra Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mitra"
