...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MITRA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mitra: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Mitra"), this);
    aboutAction->setStatusTip(tr("Show information about Mitra"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MITRA"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MITRA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MITRA addresses"));
    ...
    openAction->setStatusTip(tr("Open a MITRA: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Mitra help message to get a list with possible MITRA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Mitra client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MITRA network", "", count));
}
...
{
    QString strTitle = tr("Mitra"); // default title
