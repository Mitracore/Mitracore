...
/** Utility functions used by the MITRA Qt UI.
 */
namespace GUIUtil
{
...
// Render MITRA addresses in monospace font
...
// Parse "mitra:" URI into recipient object, return true on successful parsing
