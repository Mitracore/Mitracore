...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Mitra features */
        {"mitra", "masternode", &masternode, true, true, false},
        {"mitra", "listmasternodes", &listmasternodes, true, true, false},
        {"mitra", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mitra", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mitra", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mitra", "masternodedebug", &masternodedebug, true, true, false},
        {"mitra", "startmasternode", &startmasternode, true, true, false},
        {"mitra", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mitra", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mitra", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mitra", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mitra", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mitra", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mitra", "mnbudget", &mnbudget, true, true, false},
        {"mitra", "preparebudget", &preparebudget, true, true, false},
        {"mitra", "submitbudget", &submitbudget, true, true, false},
        {"mitra", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mitra", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mitra", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mitra", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mitra", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mitra", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mitra", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mitra", "checkbudgets", &checkbudgets, true, true, false},
        {"mitra", "mnsync", &mnsync, true, true, false},
        {"mitra", "spork", &spork, true, true, false},
        {"mitra", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"mitra", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use mitrad, or the -server option to mitra-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> mitra-cli " + methodname + " " + args + "\n";
}
