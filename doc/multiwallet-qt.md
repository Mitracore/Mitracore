...
In order to support loading of multiple wallets in mitra-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mitra.cpp.
...
Changes to mitra.cpp
----------------------
mitra.cpp is the entry point into mitra-qt, and as such, will require some minor modifications to provide hooks for
