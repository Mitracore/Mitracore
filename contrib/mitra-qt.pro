...
RESOURCES += src/qt/mitra.qrc src/qt/mitra_locale.qrc

TRANSLATIONS += src/qt/locale/mitra_bg.ts \
                src/qt/locale/mitra_de.ts \
                src/qt/locale/mitra_en.ts \
                src/qt/locale/mitra_es.ts \
                src/qt/locale/mitra_fi.ts \
                src/qt/locale/mitra_fr.ts \
                src/qt/locale/mitra_it.ts \
                src/qt/locale/mitra_ja.ts \
                src/qt/locale/mitra_pl.ts \
                src/qt/locale/mitra_pt.ts \
                src/qt/locale/mitra_ru.ts \
                src/qt/locale/mitra_sk.ts \
                src/qt/locale/mitra_sv.ts \
                src/qt/locale/mitra_vi.ts \
                src/qt/locale/mitra_zh_CN.ts \
                src/qt/locale/mitra_zh_TW.ts
