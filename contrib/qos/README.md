...
This means one can have an always-on mitrad instance running, and another local mitrad/mitra-qt instance which connects to this node and receives blocks from it.
