...
The Mitra project operates an open contributor model where anyone is
...
The following applies to code changes to the Mitra project, and is not to be
confused with overall MITRA Network Protocol consensus changes.

Whether a pull request is merged into Mitra rests with the project merge
...
Patches that change MITRA consensus rules are considerably more involved than
...
Where a patch set proposes to change the MITRA consensus, it must have been
...
The project leader is the release manager for each Mitra release.
